...
public abstract class BasePage<T extends BasePage<T>> {
    ...
    protected final SelenideElement snackbarAlertRoot = $("div[role='alert']");
    protected final SelenideElement snackbarAlertMessage = $("div[role='alert'] .MuiAlert-message");
...
//        snackbarAlertRoot.should(visible)
//                .should(text(message));
//        return (T) this;
//    }
}
